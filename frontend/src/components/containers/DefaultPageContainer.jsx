...
export default function DefaultPageContainer({text="You are not signed in", link="sign in", href="/signin", color="#eee", children}) {
    return(
        <div className="hf-md d-flex justify-content-center align-items-center flex-column" style={{ backgroundColor: color }}>
            {text && <div className="py-3 d-flex flex-column align-items-center">
